...
insert  into `address`(`id`,`userId`,`address`,`addressDetail`,`isDelete`,`recipients`,`postCode`,`mobile`) values (1,1,'湖北省武汉市洪山区','光谷意大利风情街',1,'路人甲','430200',NULL);
...
insert  into `employee`(`id`,`username`,`password`,`mobile`,`authority`) values (1,'root','4QrcOUm6Wau+VuBX8g+IPg==','13545156815',1);
...
insert  into `product`(`id`,`proName`,`oldPrice`,`price`,`proDesc`,`size`,`statu`,`updateTime`,`num`,`brandId`) values (1,'匡威三星标1970s converse复刻 142334c 144757c三星标黑色高帮',888.1,99.1,'描述','40-50',1,'2050-01-05 00:28:29',20,1),(2,'李宁闪击篮球鞋驭帅10镭射队尚4男韦德之道空袭中高帮队尚3.5球鞋',888.1,999.1,'描述','35-45',1,'2050-01-05 00:28:29',20,1),(3,'Sport飓风 Nike Kwazi 休闲运动鞋男 844839-002-001-100-400',888.1,499.1,'描述','30-50',1,'2050-01-05 00:28:29',20,1),(4,'指南针运动 NIKE HYPERSHIFT篮球鞋 844392-010-607-164-017现货',888.1,6999.1,'描述','40-55',1,'2050-01-05 00:28:29',20,1),(5,'【莹恋】MIZUNO美津浓V1GA159002乒乓球鞋男鞋女鞋室内综合训练鞋',8868.1,4969.1,'描述123123','40-50',1,'2050-01-05 00:48:05',22,2),(6,'【莹恋】MIZUNO美津浓V1GA159002乒乓球鞋男鞋女鞋室内综合训练鞋',342,112,'描述123123','35-56',1,'2050-01-05 00:48:05',44,2);
...
insert  into `user`(`id`,`username`,`password`,`mobile`,`isDelete`) values (1,'vpclub','lueSGJZetyySpUndWjMBEg==','13545156815',1);
